...
export default function SurahLayout({ children }: SurahLayoutProps) {
    return (
        ...
        <div className="flex w-ful flex-col lg:flex-row">
            <div className="fixed lg:sticky bottom-0 lg:left-0 lg:top-0 w-full h-12 lg:h-screen lg:w-20 bg-gray-100 order-2 lg:order-1"><Iconbar /></div>
            <div className="min-h-full flex flex-col pt-16 order-1 lg:order-2 mb-14 lg:mb-0">
                <div className="fixed top-0 right-0 left-0 lg:left-18 ">
                    <Navbar surahLishtSidebar={<SurahList />} />
                </div>
                <main className="flex-grow p-4 md:px-8 lg:px-4 md:py-4">
