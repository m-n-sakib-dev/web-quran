...
export default function LandingPage() {
  return (
    <div className="">
      <div className="fixed top-0 left-0 right-0"><HomeNavbar /></div>

      <div className="mt-16 min-h-screen flex flex-col items-center justify-center bg-[var(--background)] text-[var(--foreground)] transition-colors duration-300">
        ...
        <main className="text-center px-6 max-w-3xl">
          ...
          <h2 className="font-noto text-4xl md:text-6xl text-green-600 dark:text-green-400 mb-6" dir="rtl">
      ...
      <div className="fixed lg:hidden bottom-0 w-full h-12 bg-gray-100"><Iconbar /></div>
    </div>
  );
}
